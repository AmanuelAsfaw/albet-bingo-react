...
import { fetchOneData } from "../../../../redux/KenoReport/ThisYearReport/ThisYearReport.action";
...
const ThisYearComponent: FC<ThisYearPropType> = ({
    summary,
    fetchSummary,
}) => {
...
const mapStateToProps = (state: any) => ({
    summary: state.keno_this_year_report.fetchOne,
});
