...
import {
  fetchAllPreConcept,
  fetchOnePreConcept,
} from "../../../../../redux/PreConcept/PreConcept.action";
...
type Props = {
  id: number;
  pre_concept: ApiCallState<PreConceptType>;
  fetchOne: Function;
  users: any;
  fetchAll: Function;
};

const EditPreConcept = ({
  id,
  pre_concept,
  fetchOne,
  users,
  ...
  const { payload, isPending, isSuccessful } = pre_concept;
  const { id: projectId, header } = useParams();
...
const mapStateToProps = (state: any) => ({
  pre_concept: state.pre_concept.fetchOne,
});
...
const mapDispatchToProps = (dispatch: any) => ({
  fetchOne: (action: any) => dispatch(fetchOnePreConcept(action)),
});

export default connect(mapStateToProps, mapDispatchToProps)(EditPreConcept);
