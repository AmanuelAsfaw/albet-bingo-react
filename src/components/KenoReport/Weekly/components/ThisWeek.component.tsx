...
import { fetchOneData } from "../../../../redux/KenoReport/ThisWeekReport/ThisWeekReport.action";
...
const ThisYearComponent: FC<ThisWeekPropType> = ({
    summary,
    fetchSummary,
}) => {
...
const mapStateToProps = (state: any) => ({
    summary: state.keno_this_week_report.fetchOne,
});
