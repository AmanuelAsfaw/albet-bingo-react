...
import { AddDrawingPropType, sendData } from "../../utils/Drawing.util";

const AddDrawingComponent: FC<AddDrawingPropType> = ({ fetchDrawing }) => {
            ...
            <div className="col-md-6">
              ...
              >
                <Select placeholder="Select" value="type 1" >
                  ...
                  <Select.Option value="Sanitary">Sanitary</Select.Option>
...
export default connect(mapStateToProps, mapDispatchToProps)(AddDrawingComponent);
