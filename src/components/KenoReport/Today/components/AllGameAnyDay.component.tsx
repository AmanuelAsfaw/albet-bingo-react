...
import { fetchOneData } from "../../../../redux/KenoReport/AnyDayReport/AnyDayReport.action";
...
const AllGameAnyDayComponent: FC<AllGameAnyDayPropType> = ({
    summary,
    fetchSummary,
}) => {
    ...
    <>
      ...
      <div className="row mt-2">
        <div className="col-md-12">
            <Card title={`All Games Any-Day Report`}
                loading={loading}
                hoverable
                actions={[
                  <div></div>,
...
const mapStateToProps = (state: any) => ({
    summary: state.keno_any_day_report.fetchOne,
});
