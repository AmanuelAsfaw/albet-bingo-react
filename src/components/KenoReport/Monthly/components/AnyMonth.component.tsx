...
import { fetchOneData } from "../../../../redux/KenoReport/AnyMonthReport/AnyMonthReport.action";
import { useParams } from "react-router-dom";
import moment, { Moment } from "moment";

const { RangePicker } = DatePicker;

const AnyYearComponent: FC<AnyMonthPropType> = ({
    summary,
    fetchSummary,
}) => {
                  ...
                  <div>
                      <div className="col-md-2 mb-3">
                        <Form
                          ...
                          >
                            <DatePicker picker="month" onChange={(e) => setDate(e?.format("MM-DD-YYYY"))} />
                          </Form.Item>
...
const mapStateToProps = (state: any) => ({
    summary: state.keno_any_month_report.fetchOne,
});
