...
import { fetchOneData } from "../../../../redux/KenoReport/ThisMonthReport/ThisMonthReport.action";
...
const ThisYearComponent: FC<ThisMonthPropType> = ({
    summary,
    fetchSummary,
}) => {
      ...
      <div className="row mt-2">
        <div className="col-md-12">
            <Card title={`Monthly Summary`}
                ...
                actions={[
                  <div></div>,
                  <Button style={{paddingBottom: '35px'}} onClick={() => fetchSummary()}>Get</Button>
                ]}
                >
...
const mapStateToProps = (state: any) => ({
    summary: state.keno_this_month_report.fetchOne,
});
