...
import { AnyMonthPropType, deleteCategory } from "../util/Monthly.util";
...
import { fetchAllAnyMonthKenoBill } from "../../../../redux/KenoBills/AnyMonth/AnyMonthBill.action";

const AnyMonthComponent: FC<AnyMonthPropType> = ({ bills, fetchBills }) => {
...
const mapStateToProps = (state: any) => ({
  bills: state.Keno_any_month_bill.fetchAll,
});
...
const mapDispatchToProps = (dispatch: any) => ({
  fetchBills: (action: any) => dispatch(fetchAllAnyMonthKenoBill(action)),
});

export default connect(mapStateToProps, mapDispatchToProps)(AnyMonthComponent);
