...
import { fetchAllAnyDayKenoBill } from "../../../../redux/KenoBills/AnyDayBills/AnyDay.action";
...
const mapStateToProps = (state: any) => ({
  bills: state.Keno_anyday_bill.fetchAll,
});
...
const mapDispatchToProps = (dispatch: any) => ({
  fetchBills: (action: any) => dispatch(fetchAllAnyDayKenoBill(action)),
});

export default connect(mapStateToProps, mapDispatchToProps)(AnyDayByGameComponent);
