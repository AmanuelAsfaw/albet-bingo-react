...
import {
  AddSiteDiaryFileSharePropType,
  PUT,
} from "../../utils/SiteDiaryFile.util";
...
const AddSiteDiaryFileShareComponent: FC<AddSiteDiaryFileSharePropType> = ({
  document,
  documents,
  fetchDocuments,
  users,
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(AddSiteDiaryFileShareComponent);
