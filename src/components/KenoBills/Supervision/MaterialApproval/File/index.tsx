...
import AddMaterialApprovalFileComponent from "./components/Add/AddMaterialApprovalFile.component";
import AddMaterialApprovalFileShareComponent from "./components/Share/AddMaterialApprovalFileShare.component";
import {
  DELETE,
  MaterialApprovalFilePropType,
} from "./utils/MaterialApprovalFile.util";

const MaterialApprovalFileComponent: FC<MaterialApprovalFilePropType> = ({
  documents,
  fetchDocuments,
  project,
  fetchUsers,
