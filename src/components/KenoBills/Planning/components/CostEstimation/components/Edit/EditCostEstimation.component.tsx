...
import { EditCostEstimationPropType, sendData } from "../../utils/CostEstimation.util";

const EditCostEstimationComponent: FC<EditCostEstimationPropType> = ({ cost_estimation, fetchCostEstimation }) => {
    ...
    sendData(formData)
      .then(() => {
        ...
        OpenNotification(
          ...
          Message.COST_ESTIMATION_REGISTRATION_SUCCESS,
          ""
        );
      })
      .catch((error) => {
        ...
        ErrorHandler(error).map((e: any) =>
          OpenNotification(
            ...
            Message.COST_ESTIMATION_REGISTRATION_FAILED,
            e.message
          )
        );
      });
    ...
    <>
      ...
      >
        <Form
          ...
          form={form}
          initialValues={{
            date: moment(cost_estimation.date),
            description: cost_estimation.description,
            ref_no: cost_estimation.ref_no,
          }}
        >
          <div className="row">
...
export default connect(mapStateToProps, mapDispatchToProps)(EditCostEstimationComponent);
