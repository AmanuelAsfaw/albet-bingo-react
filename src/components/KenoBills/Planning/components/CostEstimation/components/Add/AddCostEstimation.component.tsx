...
import { AddCostEstimationPropType, sendData } from "../../utils/CostEstimation.util";

const AddCostEstimationComponent: FC<AddCostEstimationPropType> = ({ fetchCostEstimation }) => {
  ...
  export default connect(mapStateToProps, mapDispatchToProps)(AddCostEstimationComponent);
