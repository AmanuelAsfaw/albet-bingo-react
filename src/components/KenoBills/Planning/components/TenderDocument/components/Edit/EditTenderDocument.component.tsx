...
import { EditTenderDocumentPropType, sendData } from "../../utils/TenderDocument.util";

const EditTenderDocumentComponent: FC<EditTenderDocumentPropType> = ({ tender_document, fetchTenderDocument }) => {
    ...
    sendData(formData)
      .then(() => {
        ...
        OpenNotification(
          ...
          Message.TENDER_DOCUMENT_REGISTRATION_SUCCESS,
          ""
        );
      })
      .catch((error) => {
        ...
        ErrorHandler(error).map((e: any) =>
          OpenNotification(
            ...
            Message.TENDER_DOCUMENT_REGISTRATION_FAILED,
            e.message
          )
        );
      });
    ...
    <>
      ...
      >
        <Form
          ...
          form={form}
          initialValues={{
            date: moment(tender_document.date),
            description: tender_document.description,
            ref_no: tender_document.ref_no,
          }}
        >
          <div className="row">
...
export default connect(mapStateToProps, mapDispatchToProps)(EditTenderDocumentComponent);
