...
const DailyComponent: FC<DailyPropType> = ({
  ...
  var print_url = "albet://type=3&casher="+summary.payload.casher+"&branch="+summary.payload.branch+"&date="+date+"&startdate="+startDate+"&enddate="+endDate+"&bets="+summary.payload.total_stake+"&tickets="+summary.payload.count_total_bills+
