...
import { fetchOneData } from "../../../../redux/KenoReport/A-GameReport/A-GameReport.action";
...
const A_GameComponent: FC<A_GamePropType> = ({
    summary,
    fetchSummary,
}) => {
...
const mapStateToProps = (state: any) => ({
    summary: state.keno_a_game_today_report.fetchOne,
});
