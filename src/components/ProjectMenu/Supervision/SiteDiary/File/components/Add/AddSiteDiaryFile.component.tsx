...
import { AddSiteDiaryFilePropType, POST } from "../../utils/SiteDiaryFile.util";
...
const AddSiteDiaryFileComponent: FC<AddSiteDiaryFilePropType> = ({
  fetchDocuments,
  project,
}) => {
  ...
  const Submit = (value: any) => {
    ...
    formData.append("name", "Site Dairy");
    formData.append("type", "Site Diary");
