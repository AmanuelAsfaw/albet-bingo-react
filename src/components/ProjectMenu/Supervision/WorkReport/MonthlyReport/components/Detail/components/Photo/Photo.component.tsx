...
const PhotoComponent: FC<MonthlyDetailItemsPropType> = ({ data }) => {
  return (
    <>
      ...
      <div className="row">
        <div className="col-lg-6">
          <Statistic
            title="Prepared By"
            value={data?.prepared_by?.full_name}
            valueStyle={{ fontSize: 16, fontFamily: "Campton-Medium" }}
          />
        </div>
        <div className="col-lg-6">
          <SignatureComponent user={data?.prepared_by} />
        </div>
      </div>
      <div className="row">
        <div className="col-lg-6">
          <Statistic
            title="Checked By"
            value={data?.checked_by?.full_name}
            valueStyle={{ fontSize: 16, fontFamily: "Campton-Medium" }}
          />
        </div>
        <div className="col-lg-6">
          <SignatureComponent user={data?.checked_by} />
        </div>
      </div>
    </>
  );
