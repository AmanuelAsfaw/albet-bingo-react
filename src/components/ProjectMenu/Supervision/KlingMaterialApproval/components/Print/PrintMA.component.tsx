...
import { PrintMAPropType } from "../../util/KlingMaterialApproval.util";
import PrintHeaderComponent from "../../../../../common/PdfHeader/PrintHeader.component";
import { BASE_URI } from "../../../../../../redux/ApiCall";
import { Button, Checkbox } from "antd";

const PrintMAComponent: FC<PrintMAPropType> = ({ project, dataAction }) => {
    ...
    <div className="visible-print col-lg-12">
      ...
      <div className="row">
        <div className="col-md-8">
          <ol>
            <li>Is Submitted item in Accordance with Contract Requirements</li>
      ...
      <div className="row">
        ...
        <div className="col-md-4 border border-dark">
          <Checkbox
            checked={
              data?.kling_ma_consultant_response?.is_approved_comments === true
            }
          >
      ...
      <div className="row mt-2">
        <div className="col-md-12">
          ...
          <p className="mt-2">{data?.kling_ma_consultant_response?.comment}</p>
        </div>
      </div>
      <div className="row mt-4">
        <div className="col-md-12">
...
export default connect(mapStateToProps, mapDispatchToProps)(PrintMAComponent);
