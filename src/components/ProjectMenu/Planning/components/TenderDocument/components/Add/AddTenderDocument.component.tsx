...
import { AddTenderDocumentPropType, sendData } from "../../utils/TenderDocument.util";

const AddTenderDocumentComponent: FC<AddTenderDocumentPropType> = ({ fetchTenderDocument }) => {
  ...
  export default connect(mapStateToProps, mapDispatchToProps)(AddTenderDocumentComponent);
